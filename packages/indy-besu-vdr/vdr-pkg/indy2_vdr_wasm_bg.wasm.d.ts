...
export function indydidregistry_buildDeactivateDidTransaction(a: number, b: number, c: number, d: number, e: number): number;
...
export function credentialdefinitionregistry_buildCreateCredentialDefinitionTransaction(a: number, b: number, c: number, d: number): number;
export function credentialdefinitionregistry_buildResolveCredentialDefinitionTransaction(a: number, b: number, c: number): number;
export function credentialdefinitionregistry_parseResolveCredentialDefinitionResult(a: number, b: number, c: number, d: number): void;
...
export function wasm_bindgen__convert__closures__invoke2_mut__h51245449fe81e343(a: number, b: number, c: number, d: number): void;
