...
export function ledgerclient_new(a: number, b: number, c: number, d: number, e: number): void
...
export function indydidregistry_buildCreateDidTransaction(a: number, b: number, c: number, d: number): number
export function indydidregistry_buildUpdateDidTransaction(a: number, b: number, c: number, d: number): number
...
export function wasm_bindgen__convert__closures__invoke1_mut__ha815ddadf057bd65(a: number, b: number, c: number): void
export function wasm_bindgen__convert__closures__invoke0_mut__h939e01d05605db4f(a: number, b: number): void
export function __wbindgen_add_to_stack_pointer(a: number): number
export function __wbindgen_free(a: number, b: number, c: number): void
export function __wbindgen_exn_store(a: number): void
export function wasm_bindgen__convert__closures__invoke2_mut__h51245449fe81e343(
  a: number,
  b: number,
  c: number,
  d: number
