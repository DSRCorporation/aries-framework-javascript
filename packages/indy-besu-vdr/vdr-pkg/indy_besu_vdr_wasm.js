...
function __wbg_adapter_207(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h5b3e9702d4c211f9(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
class CredentialDefinitionRegistry {
    ...
    */
    static buildCreateCredentialDefinitionTransaction(client, from, id, cred_def) {
        ...
        const ret = wasm.credentialdefinitionregistry_buildCreateCredentialDefinitionTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(cred_def));
    ...
    */
    static buildCreateSchemaEndorsingData(client, id, cred_def) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.credentialdefinitionregistry_buildCreateSchemaEndorsingData(client.__wbg_ptr, ptr0, len0, addHeapObject(cred_def));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildCreateCredentialDefinitionSignedTransaction(client, from, id, cred_def, signature_data) {
        ...
        const ptr1 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.credentialdefinitionregistry_buildCreateCredentialDefinitionSignedTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(cred_def), addHeapObject(signature_data));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildGetCredentialDefinitionCreatedTransaction(client, id) {
        ...
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.credentialdefinitionregistry_buildGetCredentialDefinitionCreatedTransaction(client.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildGetCredentialDefinitionQuery(client, id, from_block, to_block) {
        ...
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.credentialdefinitionregistry_buildGetCredentialDefinitionQuery(client.__wbg_ptr, ptr0, len0, !isLikeNone(from_block), isLikeNone(from_block) ? BigInt(0) : from_block, !isLikeNone(to_block), isLikeNone(to_block) ? BigInt(0) : to_block);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static parseCredentialDefinitionCreatedEvent(client, log) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(client, LedgerClient);
            wasm.credentialdefinitionregistry_parseCredentialDefinitionCreatedEvent(retptr, client.__wbg_ptr, addHeapObject(log));
...
class EthrDidRegistry {
    ...
    */
    static buildDidChangeOwnerTransaction(client, sender, did, new_owner) {
        ...
        const ret = wasm.ethrdidregistry_buildDidChangeOwnerTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidChangeOwnerSignedTransaction(client, sender, did, new_owner, signature_data) {
        ...
        const ptr2 = passStringToWasm0(new_owner, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidChangeOwnerSignedTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, addHeapObject(signature_data));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidAddDelegateTransaction(client, sender, did, delegate_type, delegate, validity) {
        ...
        const ret = wasm.ethrdidregistry_buildDidAddDelegateTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, validity);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidAddDelegateEndorsingData(client, did, delegate_type, delegate, validity) {
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidAddDelegateEndorsingData(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, validity);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidAddDelegateSignedTransaction(client, sender, did, delegate_type, delegate, validity, signature_data) {
        ...
        const ptr3 = passStringToWasm0(delegate, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidAddDelegateSignedTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, validity, addHeapObject(signature_data));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidRevokeDelegateTransaction(client, sender, did, delegate_type, delegate) {
        ...
        const ptr3 = passStringToWasm0(delegate, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidRevokeDelegateTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidRevokeDelegateEndorsingData(client, did, delegate_type, delegate) {
        ...
        const ptr2 = passStringToWasm0(delegate, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidRevokeDelegateEndorsingData(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidRevokeDelegateSignedTransaction(client, sender, did, delegate_type, delegate, signature_data) {
        ...
        const ptr3 = passStringToWasm0(delegate, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidRevokeDelegateSignedTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, addHeapObject(signature_data));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidSetAttributeTransaction(client, sender, did, attribute, validity) {
        ...
        const ptr1 = passStringToWasm0(did, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidSetAttributeTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(attribute), validity);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidSetAttributeEndorsingData(client, did, attribute, validity) {
        ...
        const ptr0 = passStringToWasm0(did, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidSetAttributeEndorsingData(client.__wbg_ptr, ptr0, len0, addHeapObject(attribute), validity);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidSetAttributeSignedTransaction(client, sender, did, attribute, validity, signature_data) {
        ...
        const ptr1 = passStringToWasm0(did, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidSetAttributeSignedTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(attribute), validity, addHeapObject(signature_data));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidRevokeAttributeTransaction(client, sender, did, attribute) {
        ...
        const ptr1 = passStringToWasm0(did, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidRevokeAttributeTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(attribute));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidRevokeAttributeEndorsingData(client, did, attribute) {
        ...
        const ptr0 = passStringToWasm0(did, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidRevokeAttributeEndorsingData(client.__wbg_ptr, ptr0, len0, addHeapObject(attribute));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildDidRevokeAttributeSignedTransaction(client, sender, did, attribute, signature_data) {
        ...
        const ptr1 = passStringToWasm0(did, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildDidRevokeAttributeSignedTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(attribute), addHeapObject(signature_data));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildGetDidEventsQuery(client, did, from_block, to_block) {
        ...
        const ptr0 = passStringToWasm0(did, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ethrdidregistry_buildGetDidEventsQuery(client.__wbg_ptr, ptr0, len0, !isLikeNone(from_block), isLikeNone(from_block) ? BigInt(0) : from_block, !isLikeNone(to_block), isLikeNone(to_block) ? BigInt(0) : to_block);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
...
class SchemaRegistry {
    ...
    */
    static buildCreateSchemaTransaction(client, from, id, schema) {
        ...
        const ptr1 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.schemaregistry_buildCreateSchemaTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(schema));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildCreateSchemaSignedTransaction(client, from, id, schema, signature_data) {
        ...
        const ptr1 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.schemaregistry_buildCreateSchemaSignedTransaction(client.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(schema), addHeapObject(signature_data));
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
    ...
    */
    static buildGetSchemaQuery(client, id, from_block, to_block) {
        ...
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.schemaregistry_buildGetSchemaQuery(client.__wbg_ptr, ptr0, len0, !isLikeNone(from_block), isLikeNone(from_block) ? BigInt(0) : from_block, !isLikeNone(to_block), isLikeNone(to_block) ? BigInt(0) : to_block);
        return takeObject(ret);
    }
    /**
    * @param {LedgerClient} client
